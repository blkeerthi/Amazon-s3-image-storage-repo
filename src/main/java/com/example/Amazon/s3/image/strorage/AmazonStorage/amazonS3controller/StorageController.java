...
public class StorageController {
    ...
    public ResponseEntity<String> uploadFile(@RequestPart("spBrandingList") String spBrandingJson, @RequestParam(value="file") List<MultipartFile> file) throws FileNotFoundException, JsonProcessingException, JsonProcessingException {
