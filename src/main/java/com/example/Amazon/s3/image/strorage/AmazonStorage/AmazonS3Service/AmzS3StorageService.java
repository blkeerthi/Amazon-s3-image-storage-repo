...
import com.example.Amazon.s3.image.strorage.AmazonStorage.repositorys.SpBrandingInfoRepository;
import com.example.Amazon.s3.image.strorage.AmazonStorage.repositorys.SpBrandingRepository;
...
public class AmzS3StorageService {
    ...
    public void uploadImage(List<MultipartFile> files, SPBranding spBranding) throws FileNotFoundException {
        ...
        for (Map.Entry<String, MultipartFile> entry : matchedFiles.entrySet()) {
            ...
            spBrandingInfo.setValue(imageUrl);
